    ...
    if ($check_cart->rowCount() > 0) {
        ...
        if ($address == '') {
            ...
            if ($method === 'sari-tech' && empty($payment_details)) {
                echo "<script>alert('Please enter your Sari-Tech payment details!');</script>";
            } else {
...
<head>
    ...
    <link rel="icon" type="image/png" href="images/saritech.png">
    ...
    <section class="checkout" data-aos="fade-up">
        ...
        <form action="" method="post">
            ...
            <div class="user-info"  data-aos="fade-up">
                ...
                <div id="sari-tech-payment" data-aos="fade-up">
